package mju.nnews3.domain.member.api.controller;

import mju.nnews3.common.Response;
import mju.nnews3.domain.member.api.dto.res.QuizInfoRes;
import mju.nnews3.domain.member.api.dto.req.*;
import mju.nnews3.domain.member.api.dto.res.MainInfoRes;
import mju.nnews3.domain.member.api.dto.res.MemberNewsListRes;
import mju.nnews3.domain.member.api.dto.res.MypageRes;
import mju.nnews3.domain.member.api.dto.res.QuizRankinListRes;
import mju.nnews3.domain.member.core.service.MemberService;
