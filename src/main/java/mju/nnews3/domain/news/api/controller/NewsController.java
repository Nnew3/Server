package mju.nnews3.domain.news.api.controller;

import mju.nnews3.common.Response;
import mju.nnews3.domain.news.api.dto.res.DateNewsRes;
import mju.nnews3.domain.news.api.dto.res.BreakingNewsRes;
import mju.nnews3.domain.news.api.dto.res.DetailsNewsRes;
import mju.nnews3.domain.news.api.dto.res.NewsListRes;
import mju.nnews3.domain.news.api.dto.res.RelatedNewsListRes;
import mju.nnews3.domain.news.core.service.NewsService;
